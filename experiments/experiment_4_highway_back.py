...
run_script(road_type_factors=prefer_highway_factors,
           ...
           destination=Location(x=99.396645, y=-4.497115, z=0.600000),
           spawn_point=carla.Transform(Location(x=-41.825058, y=-19.16032, z=0.600000),
                              Rotation(pitch=360.000000, yaw=-89.609222, roll=0.000000)),
           debug=False)
